...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallDuration = findViewById(R.id.callDurationCallScreen);
        mCallerName = findViewById(R.id.remoteUserCallScreen);
        mCallState = findViewById(R.id.callStateCallScreen);

        Button callButtonRed = findViewById(R.id.hangupButton);
        callButtonRed.setOnClickListener(v -> callRed());
